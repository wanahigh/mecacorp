...
if ($lazyLoad) {
    return $this->services['knp_paginator'] = $this->createProxy('Paginator_f504f0e', function () {
        return \Paginator_f504f0e::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
