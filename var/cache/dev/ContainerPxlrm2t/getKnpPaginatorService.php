...
if ($lazyLoad) {
    return $this->services['knp_paginator'] = $this->createProxy('Paginator_1d459a3', function () {
        return \Paginator_1d459a3::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
