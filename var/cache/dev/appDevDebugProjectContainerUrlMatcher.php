...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            elseif (0 === strpos($pathinfo, '/actors')) {
                // actors_index
                if ('/actors' === $trimmedPathinfo) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                        goto not_actors_index;
                    }

                    $ret = array (  '_controller' => 'Acme\\ActorBundle\\Controller\\ActorsController::indexAction',  '_route' => 'actors_index',);
                    if (substr($pathinfo, -1) !== '/') {
                        return array_replace($ret, $this->redirect($rawPathinfo.'/', 'actors_index'));
                    }
                ...
                // actors_show
                if (preg_match('#^/actors/(?P<raisonsocial>[^/]++)/show$#s', $pathinfo, $matches)) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                        goto not_actors_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'actors_show')), array (  '_controller' => 'Acme\\ActorBundle\\Controller\\ActorsController::showAction',));
                }
                not_actors_show:
