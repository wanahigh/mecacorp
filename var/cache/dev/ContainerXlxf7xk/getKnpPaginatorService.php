...
if ($lazyLoad) {
    return $this->services['knp_paginator'] = $this->createProxy('Paginator_29d8bcb', function () {
        return \Paginator_29d8bcb::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
