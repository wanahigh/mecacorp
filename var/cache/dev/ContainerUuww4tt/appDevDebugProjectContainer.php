...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Form\\FormType' => __DIR__.'/getFormTypeService.php',
...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bjcnvcBsF8', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A6JwJs-ZPK', 0, 'J8lKwhMbRL6MsT+rDABJu1', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+YZxGJcNLZ', 0, 'J8lKwhMbRL6MsT+rDABJu1', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M-NDH9BvoX', 0, 'J8lKwhMbRL6MsT+rDABJu1', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZCJ-UOXSe7', 0, 'J8lKwhMbRL6MsT+rDABJu1', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Resources/views'), '!EasyAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ActorBundle/Resources/views'), 'AcmeActor');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ActorBundle/Resources/views'), '!AcmeActor');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AcmeActorBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/ActorBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeActorBundle' => 'Acme\\ActorBundle\\AcmeActorBundle',
            ...
            'easyadmin.config' => array(
                ...
                'entities' => array(
                    'Advert' => array(
                        'class' => 'Acme\\ActuBundle\\Entity\\Entity\\Advert',
                        'name' => 'Advert',
                    ),
                    'Actors' => array(
                        'class' => 'Acme\\ActorBundle\\Entity\\Actors',
                        'name' => 'Actors',
                    ),
                    'User' => array(
