...
if ($lazyLoad) {
    return $this->services['knp_paginator'] = $this->createProxy('Paginator_46af1c7', function () {
        return \Paginator_46af1c7::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
